                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-end gap-16 justify-between text-sm pt-16 w-full">
                        ...
                        <div>
                            ...
                            <div className="flex justify-center">
                                <input type="email" placeholder="EMAIL ADDRESS" className="px-6 py-4"></input>
                                <button
                                    className="uppercase bg-black px-6 border-2 border-black hover:bg-blue-500 hover:border-blue-500 hover:text-gray-950 duration-300 ">send</button>
                            </div>
                        </div>
                    </div>
