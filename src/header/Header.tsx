    ...
    return (
        <header className="bg-white">
            <div className='container sticky top-0'>
                <div
                    className='px-10 h-24 flex justify-between items-center bg-white lg: border-b-2 border-gray-600 shadow-md'>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="135" height="17" viewBox="0 0 135 17" fill="none"
                            ...
                            <mask id="mask0_1_10" maskUnits="userSpaceOnUse" x="0" y="-7"
                                width="136" height="30">
                    ...
                    <div>
                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block lg:hidden">
                        ...
                        <ul className='hidden lg:flex justify-between items-center gap-10'>
                            ...
                            <li className='hover:text-blue-500 duration-300 cursor-pointer'>Latest</li>
